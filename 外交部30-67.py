...
try:
    for idx in range(29,67):
        ...
        while count < len(a_elements):
            ...
            text =driver.find_elements(By.XPATH,f"/html/body/div[1]/div[5]/div[2]/div[2]/ul/li[{count+1}]")[0].text
